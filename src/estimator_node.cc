...
static std::string config_file = "/home/fansa/Src/317/lio_mapping/catkin_ws/src/lio-mapping/config/indoor_test_config.yaml";
...
int main(int argc, char **argv) {
	...
	nh_ptr->param("config_file", config_file, std::string("/home/fansa/Src/317/lio_mapping/catkin_ws/src/lio-mapping/config/indoor_test_config.yaml"));
